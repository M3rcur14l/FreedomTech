...
<title>Login</title>
<!--Foundation Styles-->
<link href="<c:url value="/resources/css/foundation.css"/>" rel="stylesheet" type="text/css">
<link href="<c:url value="/resources/css/foundation.min.css"/>" rel="stylesheet" type="text/css">
<link href="<c:url value="/resources/css/normalize.css"/>" rel="stylesheet" type="text/css">
<!--My styles-->
<link href="<c:url value="/resources/css/login.css"/>" rel="stylesheet" type="text/css">
<!--Foundation Scripts-->
<script src="<c:url value="/resources/js/foundation/foundation.js"/>" type="text/javascript"></script>
<script src="<c:url value="/resources/js/vendor/jquery.js"/>"></script>
<script src="<c:url value="/resources/js/foundation.min.js"/>" type="text/javascript"></script>
<script src="<c:url value="/resources/js/vendor/modernizr.js"/>" type="text/javascript"></script>
...
<body>
	...
	<div id="main" class="row">
		...
		<div id="mainbody" class="large-12 columns">
			<div class="panel">
				<p>Login to facebok to acces the app feature</p>
				<br />
				...
				<div class="row">
					...
					<div class="large-7 columns small-7 columns">
						<ul class="inline-list right">
							<li>developers: <br />Antonello Fodde <br />Chai Botta
							</li>
						</ul>
					</div>
				</div>
