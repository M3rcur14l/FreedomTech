...
<![endif]-->
	...
	<article>
		<h1>Welcome to FreedomTech!</h1>

		<p>The world's best assistive technology products, service, and
			support. With over 30 years of combined industry experience our goal
			is to provide you with the best assistive technology buying
			experience. With the finest products on the planet, lifetime product
			support, and world class service we guarantee we will exceed your
			expectations.</p>
		<br>
		<h2>Start exploring all categories:</h2>
